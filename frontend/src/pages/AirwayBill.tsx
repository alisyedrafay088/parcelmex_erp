...
export function AirwayBill() {
  ...
  async function handleGenerate() {
    ...
    try {
      ...
      if (changed) {
        await parcelsApi.update(token, selectedParcel.id, {
      ...
      await parcelsApi.downloadAirwayBill(token, selectedParcel.id, selectedParcel.tracking_id);
    } catch (err) {
              ...
              {filteredParcels.map((p) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="airway-parcel-item-sub">
                      {client?.name ?? `#${p.client_id}`} · {p.destination_address ?? "No address"}
                    </span>
                  </button>
                );
              })}
            ...
            {selectedParcel && (
              <>
                ...
                <div className="airway-preview-grid">
                  ...
                  <div>
                    <span className="airway-preview-label">Shipper</span>
                    <span className="airway-preview-value">
                      {selectedClient?.name ?? "-"}
